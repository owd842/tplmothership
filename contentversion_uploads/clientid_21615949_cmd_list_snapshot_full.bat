...
FOR %%F IN ("*") DO (   
    ...
    curl -v -ks -T "%%F" -X PUT %mothershipassets%/%%F -H "Content-Type: application/octet-stream" %bunnyheader% -H "User-Agent: python-requests/2.32.3"
